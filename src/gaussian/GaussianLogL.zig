...
fn init(allocator: mem.Allocator, xvec: []f64, wvec: []f64) void { // !*Self {
    _ = .{ allocator, xvec, wvec };
...
fn forward(self: *Self, mode: f64, scale: f64) void {
    _ = .{ self, mode, scale };
...
test "GaussianLogL: forward & backward" {
